...
func loadConfig(configFile string) (*config.Config, error) {
	...
	// ExecutionCleanupConfig tags are documentation only; Viper will otherwise
	// leave omitted values at their Go zero values and silently disable cleanup.
	// Set defaults before Unmarshal so explicit config values, including false,
	// retain precedence.
